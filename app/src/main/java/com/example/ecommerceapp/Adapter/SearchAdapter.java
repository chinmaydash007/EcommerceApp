...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.FurnitureViewHolder> {
    ArrayList<Furniture> furnitureList;
    Context context;

    public SearchAdapter(ArrayList<Furniture> furnitures, Context context) {
